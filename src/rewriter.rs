...
use crate::expr_type_evaluator::evaluate_type;
use crate::field::field_name;
use crate::field_mapper::{field_and_dimensions, FieldTypeMap, TagSet};
use crate::{provider::SchemaProvider, util};
use datafusion::common::{DataFusionError, Result};
use influxql_parser::common::{MeasurementName, QualifiedMeasurementName};
use influxql_parser::expression::walk::{walk_expr, walk_expr_mut};
use influxql_parser::expression::{Expr, VarRefDataType, WildcardType};
use influxql_parser::identifier::Identifier;
use influxql_parser::literal::Literal;
use influxql_parser::select::{
...
fn has_wildcards(stmt: &SelectStatement) -> (bool, bool) {
    use influxql_parser::visit::{Recursion, Visitable, Visitor};
...
// #[cfg(test)]
// mod test {
//     use crate::rewriter::{has_wildcards, rewrite_statement};
//     use crate::test_utils::{parse_select, MockSchemaProvider};
