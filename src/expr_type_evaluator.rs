use crate::field::field_by_name;
use crate::field_mapper::map_type;
use crate::provider::SchemaProvider;
use datafusion::common::{DataFusionError, Result};
use influxql_parser::common::{MeasurementName, QualifiedMeasurementName};
use influxql_parser::expression::{Expr, VarRefDataType};
use influxql_parser::literal::Literal;
use influxql_parser::select::{Dimension, FromMeasurementClause, MeasurementSelection};
