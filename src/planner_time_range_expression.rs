...
use crate::util::binary_operator_to_df_operator;
...
use influxql_parser::{expression::Expr, literal::Literal};
...
/// hand side of a [`ConditionalExpression`][influxql_parser::expression::ConditionalExpression]
...
pub(crate) fn time_range_to_df_expr(expr: &Expr, tz: Option<chrono_tz::Tz>) -> ExprResult {
...
mod test {
    ...
    use influxql_parser::expression::ConditionalExpression;
